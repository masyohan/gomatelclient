    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        ...
        return AlertDialog(
          ...
          content: new Text("Berhasil Melakukan Pendaftaran !"),
          actions: <Widget>[
              ...
              children: <Widget>[
                ...
                Padding(
                  ...
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(
                        ...
                        focusedBorder: UnderlineInputBorder(
                            borderSide: BorderSide(
                                color: Style.darkindigo, width: 2.0))),
                  ),
                ),
                Padding(
                  padding: EdgeInsets.only(bottom: 14.0),
                ...
                Container(
                  ...
                  child: Column(
                      ...
                      children: <Widget>[
                        Text(
                            'Dengan mengeklik \'Daftar\', maka anda telah membaca dan setuju dengan',
                            style:
                        ...
                        Row(
                          children: <Widget>[
                            ...
                            TextButton(
                              text: Text('Persyaratan',
                                  style: Style.body2
                                      .copyWith(color: Style.oldred)),
                            ),
                          ],
                        ),
                        Text(' yang telah kami tentukan',
                            style:
                                Style.body2.copyWith(color: Style.slategrey)),
                      ]),
                ),
                      ...
                      if (snapshot.hasData) {
                        if (snapshot.data.statusCode == 200) {
                          WidgetsBinding.instance
                              .addPostFrameCallback((_) => _showSuccess());
