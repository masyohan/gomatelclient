      ...
      showDialog(
        ...
        builder: (BuildContext context) {
          ...
          return AlertDialog(
            ...
            content: new Text("Yakin Ingin Menghapus ?"),
            actions: <Widget>[
                      ...
                      /*Container(
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            ...
                            Text(_profile.plate,
                                style: Style.h6.copyWith(color: Style.oldred)),
                          ],
                        ),
                      ),*/
                      Container(
                          ...
                          children: <Widget>[
                            ...
                            Container(
                                ...
                                child: Text(
                                  _profile.vehicle,
                                  style:
                                      Style.body2.copyWith(color: Style.oldred),
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            Container(
                                alignment: Alignment.centerLeft,
                                child: Text(
                                  '${_profile.finance},${_profile.address}${_profile.phone}',
                                  style:
                                      Style.body2.copyWith(color: Style.oldred),
                                  textAlign: TextAlign.left,
                                  maxLines: 1,
                      ...
                      children: <Widget>[
                        TextIconButton(
                          ...
                          text: Text(
                            ...
                            style: Style.caption.copyWith(color: Style.oldred),
                          ),
                          onPressed: (context) => Share.share('GO-Matel Apps\n' +
                              'Tolong dicek\n' +
                              '----------------------------\n' +
                        ...
                        TextIconButton(
                            ...
                            text: Text(
                              ...
                              textAlign: TextAlign.center,
                              style:
                                  Style.caption.copyWith(color: Style.oldred),
                            ),
                        ...
                        TextIconButton(
                          icon: Padding(
                            ...
                            child: Icon(Icons.delete,
                                color: Style.lightred, size: 18.0),
                          ),
                          text: Text(
                            'Hapus\nData',
                            textAlign: TextAlign.center,
                          ...
                          onPressed: (context) {
                            _confirmDelete(_profile.id.toString());
                            /*
                            Navigator.push(
                                context,
                                MaterialPageRoute(
